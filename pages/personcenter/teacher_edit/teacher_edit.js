...
Page({
  ...
  getteacherdetail:function()
  {
    ...
    query.find().then(res => {
      wx.hideLoading();
      itemid = res[0].objectId;
      that.setData({
        detail:res[0],
        selectclass: res[0].class.slice(0, 2),
        selectclass1: res[0].class.slice(2, 4)
        })
    });
  },
  ...
  picktsex: function (e) {
    this.setData({
      ...
      picksex: that.data.sex[e.detail.value]
    })
  },
  ...
  pickclass: function (e) {
    ...
    this.setData({
      ...
      selectclass: that.data.class1[e.detail.value]
    })
  },
